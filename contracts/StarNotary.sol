...
contract StarNotary is ERC721 {
    ...
    string public constant name = "LUC START TOKEN";
    string public constant symbol = "LSTT";
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address sender = msg.sender;
        address ownrAddress = ownerOf(_tokenId);
        if(sender == ownrAddress){
            _transferFrom(ownrAddress, _to1, _tokenId);
        }        
    }
}
